...
def get_user_messages_by_email(token, email):
	return cursor.execute("SELECT message, sender FROM messages WHERE receiver = '"+email+"';").fetchall()
...
def post_message(sender, receiver, message):
	cursor.execute("INSERT INTO messages ('receiver', 'sender', 'message') VALUES ('"+sender+"','"+receiver+"','"+message+"');");
	db.commit()
